...
export default function Product(props){
    ...
    const image = product.pictures ? product.pictures[0].url : '/images/sin_imagen.jpg'

    return (
        <div className="max-w-4xl md:h-96 mt-10 md:mt-20 mx-auto w-full bg-white md:flex rounded-md shadow-lg items-center">
